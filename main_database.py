...
C2 = Molecule('dicarbon','C2',1977,'C2','Cygnus OB2 - 12 LOS','Mt Hopkins','IR',neutral=True,C=2,d_ref='Souza and Lutz 1977 ApJ 216, L49',lab_ref='Phillips 1948 ApJ 107, 389',notes=None)
...
H2S = Molecule('hydrogen sulfide','H2S',1972,'H2S','W3, W3(OH), Orion, NGC 2264, Sgr B2, W51, DR 21(OH), NGC 7538','NRAO 36-ft','mm',neutral=True,H=2,S=1,d_ref='Thaddeus et al. 1972 ApJ 176, L73',lab_ref='Cupp et al. 1968 Phys Rev 171, 60',notes=None,exgal=True,exgal_d_ref='Hekkila et al. 1999 A&A 344, 817',exgal_sources='LMC')
...
C3 = Molecule('tricarbon','C3',1988,'C3','IRC+10216','KPNO 4-m','IR',neutral=True,C=3,d_ref='Hinkle et al. 1988 Science 241, 1319',lab_ref='Gausset et al. 1965 ApJ 142, 45',notes=None)
