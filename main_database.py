...
H2S = Molecule('hydrogen sulfide','H2S',1972,'H2S','W3, W3(OH), Orion, NGC 2264, Sgr B2, W51, DR 21(OH), NGC 7538','NRAO 36-ft','mm',neutral=True,H=2,S=1,d_ref='Thaddeus et al. 1972 ApJ 176, L73',lab_ref='Cupp et al. 1968 Phys Rev 171, 60',notes=None,exgal=True,exgal_d_ref='Hekkila et al. 1999 A&A 344, 817',exgal_sources='LMC',ppd=True,ppd_d_ref='Phuong et al. 2018 A&A in press')
